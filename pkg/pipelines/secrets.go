...
func createOpaqueSecret(name types.NamespacedName, data, secretName string) (*corev1.Secret, error) {
	r := strings.NewReader(data)

	return createSecret(name, secretName, corev1.SecretTypeOpaque, r)
}
