...
func NewCmdBootstrap(name, fullName string) *cobra.Command {
	...
	initCmd.Flags().StringVar(&o.ServiceRepoURL, "service-repo-url", "", "Application source e.g. https://github.com/organisation/application")
	initCmd.Flags().StringVar(&o.ServiceWebhookSecret, "service-webhook-secret", "", "Provide the GitHub webhook secret for Application repository (if not provided, it will be auto-generated)")
