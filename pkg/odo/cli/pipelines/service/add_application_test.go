	...
	cmdTests := []struct {
		...
		{"Missing app-name flag",
			[]keyValuePair{flag("gitops-repo", "example/repo"),
				flag("service-git-repo", "example/repo"), flag("service-webhook-secret", "abc123"), flag("env-name", "sample"), flag("skip-checks", "true")},
		...
		{"Missing service-webhook-secret flag",
			[]keyValuePair{flag("app-name", "app"),
				flag("gitops-repo", "example/repo"), flag("service-git-repo", "sample/repo"), flag("env-name", "sample"), flag("skip-checks", "true")},
			`Required flag(s) "service-webhook-secret" have/has not been set`},
		{"Missing env-name flag",
			[]keyValuePair{flag("app-name", "app"),
				flag("gitops-repo", "example/repo"), flag("service-git-repo", "sample/repo"), flag("service-webhook-secret", "abc123"), flag("skip-checks", "true")},
